...
description: Journey Optimizer web エディターでシングルページアプリケーション（SPA）を作成する方法について説明します。
feature: Web Channel
role: Developer
level: Intermediate
...
Journey Optimizer web エディターでシングルページアプリケーション（SPA）を作成する方法について説明します。
...
>[!VIDEO](https://video.tv.adobe.com/v/3446886/?captions=jpn&learn=on)
