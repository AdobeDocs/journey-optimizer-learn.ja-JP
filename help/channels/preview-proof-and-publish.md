---
title: プレビュー、配達確認、公開
description: Litmus を使用してインボックスをまたぐメールのレンダリングをテストする方法や、テストプロファイルに合わせてパーソナライズされたメールをプレビューし、配達確認を送信し、メールを公開する方法について説明します。
jira: KT-7533
...
>[!VIDEO](https://video.tv.adobe.com/v/3430339?captions=jpn&quality=12&learn=on){transcript=true}
