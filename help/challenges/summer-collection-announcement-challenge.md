...
description: 既存の顧客のオーディエンスに夏物コレクションのお知らせを送信して、新しい Luma 夏物コレクションを宣伝します。
jira: KT-8109
...
架空のアスレチックアパレル会社である Luma は、最新のアパレルとギアコレクションを宣伝し、既存顧客の売り上げを伸ばしています。 Luma は、新しい夏物コレクションを発表しており、様々なオーディエンスを具体的にターゲットにしたいと考えています。

## 課題

Luma マーケティングチームから、Journey Optimizer で夏物コレクションのマーケティングキャンペーンを実装するよう依頼されています。 課題は、次のとおりです。

* プロモーションを受け取る選定プロファイルを定義するオーディエンスを作成します。
* ジャーニーを構築します。

### 手順 1：オーディエンスの定義 - アクティブな顧客

>[!BEGINTABS]

>[!TAB タスク]

#### [!DNL Journey Optimizer] でのオーディエンスの作成

* [!DNL Journey Optimizer] で&#x200B;*アクティブな顧客*&#x200B;というオーディエンスを作成します。
...
結果：\
メールが届きます。 件名は、次のようになります。*Stanleigh 様、メンズの新作アスレチックギアをチェックしてください* とメール本文は、プレビューで確認した内容と一致している必要があります。
