...
description: 保存したパーソナライゼーションライブラリ項目をメッセージで使用する方法と、パーソナライゼーションライブラリ項目を作成および管理する方法について説明します。
...
>[!VIDEO](https://video.tv.adobe.com/v/344987?captions=jpn&quality=12&learn=on){transcript=true}
