...
### Journey Optimizer モバイルのユースケースに必要なモバイル SDK コンポーネント

Journey Optimizer モバイルチャネル（プッシュ、アプリ内、コンテンツカード、コードベースのエクスペリエンス）を使用するには、次の拡張機能をインストールして設定する必要があります。

![ 必要な拡張機能 ](/help/mobile-learning-hub/assets/extensions.png)
