...
+ [ロイヤルティ](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/loyalty/introduction-to-loyalty/discover-journey-optimizer-loyalty)
...
+ 決定機能{#decision-capabilities}
  ...
  + 意思決定管理 {#decision-management}
    ...
    + [パーソナライズされたオファーを作成](/help/decision-management/create-personalized-offers.md)
...
+ 設定 {#configuration}
  + チャネルの設定 {#channel-configuration}
    ...
    + メールチャネル {#email-channel}
      + [IP プールの作成](/help/set-up-channels/create-ip-pool.md)
    ...
    + SMS／MMS／RCS チャネル {#sms-mms-channel}
      ...
      + [RCS の設定](/help/set-up-channels/set-up-rcs.md)
...
+ ユースケースとベストプラクティス{#use-cases}
  ...
  + [Web SDK とリアルタイム天候データを使用した Adobe Journey Optimizer でのオファーのパーソナライズ](https://experienceleague.adobe.com/ja/docs/journey-optimizer-learn/personalizing-offers-with-real-time-weather-data/introduction){target="_blank"}
