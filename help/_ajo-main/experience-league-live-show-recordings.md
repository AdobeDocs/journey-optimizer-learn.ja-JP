...
<div class="columns">
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/ja/docs/events/experience-league-live-recordings/episodes/exl-live-episode-04-08-26" title="顧客エンゲージメントの新しいユースケース：iOSのライブアクティビティ、web プッシュ、永続的なメッセージ（2026年4月8日（PT））" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3483389/?format=jpeg&nocache=1775836544790" alt="顧客エンゲージメントの新しいユースケース：iOSのライブアクティビティ、web プッシュ、永続的なメッセージ（2026年4月8日（PT））"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/events/experience-league-live-recordings/episodes/exl-live-episode-04-08-26" target="_blank" rel="referrer" title="顧客エンゲージメントの新しいユースケース：iOSのライブアクティビティ、web プッシュ、永続的なメッセージ（2026年4月8日（PT））">顧客エンゲージメントの新しいユースケース：iOSのライブアクティビティ、Web プッシュ、永続的なメッセージ（2026年4月8日（PT）/12日（PT）） </a>
                    </p>
                    <p class="is-size-6">このExperience Leagueライブセッションでは、企業が一方向のシングルチャネルメッセージを超えて進化する中で、顧客エンゲージメントの新しいサーフェスとユースケースを探ります。 マーケティングチームと製品チームが、より可視的でコンテキストに即した永続的なエクスペリエンスを構築し、継続的なエンゲージメントと、チャネルをまたいでより豊かでリアルタイムのインタラクションを促進する方法をご確認ください。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Get to Know Campaign Orchestration in Adobe Journey Optimizer (March 12, 2026)">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/ja/docs/events/experience-league-live-recordings/episodes/exl-live-episode-03-12-26" title="Get to Know Campaign Orchestration in Adobe Journey Optimizer（2026年3月12日）" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3481409/?format=jpeg&nocache=1775836544792" alt="Get to Know Campaign Orchestration in Adobe Journey Optimizer（2026年3月12日）"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/ja/docs/events/experience-league-live-recordings/episodes/exl-live-episode-03-12-26" target="_blank" rel="referrer" title="Get to Know Campaign Orchestration in Adobe Journey Optimizer（2026年3月12日）">Adobe Journey OptimizerのCampaign オーケストレーションについて（2026年3月12日） </a>
                    </p>
                    <p class="is-size-6">Experience Leagueのライブセッションでは、Journey Optimizerのキャンペーンオーケストレーション機能を利用して、オーディエンスの構築から施策の立ち上げに至るまで、大規模な1対1のマルチチャネルマーケティングプログラムを管理する方法を紹介します。</p>
                </div>
...
<div class="columns">
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">このドラマでは、Travis Jordan氏とNikhil Sharma氏が、Adobe Journey Optimizerが最近、WhatsApp、RCS、カスタム SMS プロバイダーなどの強力な新しいチャネル機能を追加し、モバイルエンゲージメントを強化した方法を紹介します。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Experience League LIVE Events">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/docs/events/experience-league-live-recordings/episodes/exl-live-episode-05-12-22.html?lang=ja" title="EXPERIENCE LEAGUE LIVE EVENTS" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://experienceleague.adobe.com/docs/events/experience-league-live-recordings/episodes/exl-live-episode-05-12-22.html?lang=ja./media_162a4f3c7f00f727975830a7b28481d0c762fa319.jpg?width=400&format=jpg&optimize=medium" alt="EXPERIENCE LEAGUE LIVE EVENTS"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/docs/events/experience-league-live-recordings/episodes/exl-live-episode-05-12-22.html?lang=ja" target="_blank" rel="referrer" title="EXPERIENCE LEAGUE LIVE EVENTS">Experience League ライブイベント </a>
                    </p>
