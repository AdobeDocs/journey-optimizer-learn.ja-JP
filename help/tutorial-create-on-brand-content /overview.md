...
Adobe Journey OptimizerのAIを利用して、ブランドの設定からキャンペーン全体の生成、ビジュアルの強化、多言語バージョン、自動化された品質チェックに至るまで、ブランドに即したコンテンツを制作、調整、管理する方法を解説します。あらゆるチャネルをまたいで、パーソナライズされた一貫性のあるコンテンツを拡張したいマーケター向けに構築されています。

## 学習すること

### 概要とブランド設定

このモジュールでは、Adobe Journey Optimizerでブランドを設定し、AI生成コンテンツに最初から誰であるかを反映させることができます。
...
このモジュールでは、Adobe Journey OptimizerのAI機能を利用して、エンドツーエンドでブランドに即したコンテンツを制作、調整する方法を紹介します。
...
このモジュールは、AIが生成したコンテンツを公開前に評価し、管理するのに役立ちます。
