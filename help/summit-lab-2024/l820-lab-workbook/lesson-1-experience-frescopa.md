---
title: レッスン 1 - Experience Fréscopa
description: Fréscopaのウェブサイトで様々なシナリオを体験してください。
feature: Push, In App
role: User
level: Intermediate
doc-type: Tutorial
...
* Fréscopaでアカウントを作成します。
* モバイルアプリをダウンロードしてインストールします。
* Fréscopaのウェブサイトで様々なシナリオを体験してください。
...
1. 次のページで、詳細を入力します。
   ...
   1. ラボ中にアクセスできる&#x200B;**電子メールアドレス**&#x200B;を入力してください。

      >[!IMPORTANT]
      > 必ず登録したメールアドレスと、ラボ中にメールアカウントにアクセスできることを忘れないようにしてください。 Web サイトとアプリにログインする際に必要です。

   1. ラボで作成したSMS メッセージを受け取るには、次の国コードを含む&#x200B;**携帯電話番号**&#x200B;を入力します。

      例：`+14502741234`

   1. **住所**&#x200B;と&#x200B;**市区町村**&#x200B;を入力してください。
...
アプリをインストールした後、Adobeのエンタープライズ版デベロッパーを信頼する必要があります。
...
Androidでは、以下に示すアラート手順に従ってAPKをダウンロードしてインストールします。

![Android ダウンロード画面](/help/summit-lab-2024/l820-lab-workbook/assets/1-2-5-android-download.jpg "Android ダウンロード画面"){width="250" align="center" zoomable="yes"}
<br>
...
* ログイン。
* Web サイトを探索して、Web アプリ内メッセージをトリガーします。
* ショッピングカートに商品を追加します。
* 買い物かごをチェック。
...
次のレッスンでは、Adobe Journey Optimizerでモバイルとweb エクスペリエンスを作成する方法について説明します。
